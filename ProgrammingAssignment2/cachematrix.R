...
##-----------------------------------------------------------------------------
## 'cacheSolve()' get as input argument the list generated by 'makeCacheMatrix' 
...
makeCacheMatrix <- function(x = matrix()) {
        ...
        # set (cache) the inverse computed by 'cacheSolve()'
...
## 'cacheSolve(x)' get as input argument the list generated by 'makeCacheMatrix'
